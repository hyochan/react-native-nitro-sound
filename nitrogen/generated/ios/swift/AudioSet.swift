...
public extension AudioSet {
  ...
  var AVModeIOS: AVModeIOSOption? {
    @inline(__always)
    get {
      return self.__AVModeIOS.has_value() ? self.__AVModeIOS.pointee : nil
    }
    @inline(__always)
    set {
  ...
  var AVEncodingOptionIOS: AVEncodingOption? {
    @inline(__always)
    get {
      return self.__AVEncodingOptionIOS.has_value() ? self.__AVEncodingOptionIOS.pointee : nil
    }
    @inline(__always)
    set {
  ...
  var AVFormatIDKeyIOS: AVEncodingOption? {
    @inline(__always)
    get {
      return self.__AVFormatIDKeyIOS.has_value() ? self.__AVFormatIDKeyIOS.pointee : nil
    }
    @inline(__always)
    set {
  ...
  var AVNumberOfChannelsKeyIOS: Double? {
    @inline(__always)
    get {
      return self.__AVNumberOfChannelsKeyIOS.has_value() ? self.__AVNumberOfChannelsKeyIOS.pointee : nil
    }
    @inline(__always)
    set {
  ...
  var AVSampleRateKeyIOS: Double? {
    @inline(__always)
    get {
      return self.__AVSampleRateKeyIOS.has_value() ? self.__AVSampleRateKeyIOS.pointee : nil
    }
    @inline(__always)
    set {
  ...
  var AudioQuality: AudioQualityType? {
    @inline(__always)
    get {
      return self.__AudioQuality.has_value() ? self.__AudioQuality.pointee : nil
    }
    @inline(__always)
    set {
  ...
  var AudioChannels: Double? {
    @inline(__always)
    get {
      return self.__AudioChannels.has_value() ? self.__AudioChannels.pointee : nil
    }
    @inline(__always)
    set {
  ...
  var AudioSamplingRate: Double? {
    @inline(__always)
    get {
      return self.__AudioSamplingRate.has_value() ? self.__AudioSamplingRate.pointee : nil
    }
    @inline(__always)
    set {
  ...
  var AudioEncodingBitRate: Double? {
    @inline(__always)
    get {
      return self.__AudioEncodingBitRate.has_value() ? self.__AudioEncodingBitRate.pointee : nil
    }
    @inline(__always)
    set {
